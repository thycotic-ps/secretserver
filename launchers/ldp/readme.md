...
This document provides the details for creating a custom Launcher for LDP. 

## Template

The secret template for LDP can be found here to import: 
...
1. Click **New**
1. Enter a **Launcher Name** ex: `LDP Launcher`
1. Enter the **Process Name**: `cmd`
1. Enter the **Process Arguments**: `/c "C:\Windows\System32\ldp.exe"`
