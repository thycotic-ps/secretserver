...
This document provides the details for creating a custom Launcher for UltraVNC. 

## Template

The secret template for UltraVNC can be found here to import: 
...
1. Click **New**
1. Enter a **Launcher Name** ex: `UltraVNC Launcher`
1. Enter the **Process Name**: `C:\Program Files\uvnc bvba\UltraVNC\vncviewer.exe`
1. Enter the **Process Arguments**: `/user $USERNAME /password $PASSWORD -connect $MACHINE`
